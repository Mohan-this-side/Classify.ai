  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'electric-glow': 'radial-gradient(circle at center, rgba(56, 189, 248, 0.4), transparent 70%)',
      },
      backgroundSize: {
        'cyber-grid': '20px 20px',
      },
      boxShadow: {
        'neon-sm': '0 0 5px rgba(168, 85, 247, 0.5)',
        'neon': '0 0 10px rgba(168, 85, 247, 0.5), 0 0 20px rgba(168, 85, 247, 0.3), 0 0 30px rgba(168, 85, 247, 0.1)',
        'neon-lg': '0 0 15px rgba(168, 85, 247, 0.6), 0 0 30px rgba(168, 85, 247, 0.4), 0 0 45px rgba(168, 85, 247, 0.2)',
        'electric': '0 0 10px rgba(56, 189, 248, 0.5), 0 0 20px rgba(56, 189, 248, 0.3), 0 0 30px rgba(56, 189, 248, 0.1)',
        'cyber': '0 0 10px rgba(34, 197, 94, 0.5), 0 0 20px rgba(34, 197, 94, 0.3)',
        'dark-lg': '0 10px 15px -3px rgba(0, 0, 0, 0.3), 0 4px 6px -2px rgba(0, 0, 0, 0.1)',
        'inner-neon': 'inset 0 0 10px rgba(168, 85, 247, 0.2)',
      },
      animation: {
